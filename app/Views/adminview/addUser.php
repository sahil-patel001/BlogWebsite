...
<div class="container">
    <h1 class="text-secondary text-center">Add User</h1>
    <hr>
    </br>
    </br>
    <div class="col-lg-6 m-auto">
        <form class="row g-3" action="<?php echo site_url('Pages/save') ?>" method="post">
            ...
            <div class="col-12">
                <a href="<?php echo site_url('admin/userManagement') ?>" class="btn btn-primary"><i class="bi bi-arrow-left-circle-fill"></i></a>
            </div>
        </form>
        <br>
        <br>
